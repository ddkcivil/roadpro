...
- [ ] 3. Create GISRoadModule.tsx (unified module)
- [ ] 4. Update navigation.ts
- [ ] 5. Update App.tsx to use unified module
- [x] 6. Get user confirmation

## Implementation Details

### GISRoadModule.tsx Structure
...
### Navigation Updates
- Replace 'map' + 'road-inventory' with 'gis-road'
- Single unified tab

### App.tsx Updates
- Use single GISRoadModule component
- Remove separate MapModule + RoadInventoryModule imports
