...
const isPlaceholder = (val) => !val || val.includes('your-project') || val.includes('your-anon');
...
export const supabaseAdmin = createClient(finalUrl, supabaseServiceKey || finalAnonKey);
