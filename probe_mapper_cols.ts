...
async function check() {
  const cols = [
    'agencymaterials', 'subcontractorpayments', 'purchaseorders',
    'accountingintegrations', 'accountingtransactions', 'structuretemplates',
    'auditlogs', 'resourceallocations', 'complianceworkflows'
  ];
